...
COMMAND_MODULES = {
    "simulate": "or_pgee_comparison.run_simulation",
    "figure1": "or_pgee_comparison.plot_figure1",
    "figure-b1": "or_pgee_comparison.plot_figureB1",
    "pp-plots": "or_pgee_comparison.plot_pp",
    "benchmark": "or_pgee_comparison.benchmark_speed",
}
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m or_pgee_comparison",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    for pair in ("rr", "or"):
        _run_module(
            "or_pgee_comparison.plot_figure1",
            ("--pair", pair, "--metric", "all"),
        )
    _run_module("or_pgee_comparison.plot_figureB1")
    _run_module("or_pgee_comparison.plot_pp")
    return 0
