...
- `REPO_ROOT`: repository root containing `RR_OR_GEE_PGEE/`
...
1. Build a new, self-contained `RR_OR_GEE_PGEE/` implementation without modifying published-result scripts.
...
- Implement new code only in `RR_OR_GEE_PGEE/`.
