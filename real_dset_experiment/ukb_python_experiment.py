...
DEFAULT_UKB_DIR = SCRIPT_DIR / "UKB"
DEFAULT_PYTHON_RESULTS_DIR = DEFAULT_UKB_DIR / "python_results"
DEFAULT_ANATOMICAL = (
    SCRIPT_DIR.parents[1] / "CBMR" / "ALE" / "template" / "MNI152_T1_2mm_brain.nii.gz"
)
